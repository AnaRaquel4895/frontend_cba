...
const persmisionsRoles:any ={
  ...
  profesor:{
    permissions:[
      ...
      'can_list_gestiones',
      'can_read_eventos', //nuevo
      'can_read_events_calendario', //nuevo
      'can_list_eventos',
      'can_read_noticias', //nuevo
      'can_list_noticias',
    ]
